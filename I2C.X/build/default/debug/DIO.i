...
if((DIO_info -> port)== 0)
 ADCON1 |=( DIO_info -> operation_mode) ;
if(DIO_info != '\0'){
    switch (DIO_info -> dir)
    {
      case 0x00:
        switch (DIO_info -> port)
        {
           ...
           PORTA |=(DIO_info-> pin) ;
            ...
            case 2:
                ...
                *((reg_type8_t)(0x0F94)) |=(DIO_info->pin) ;
            break;
            case 3:
